...
export default function AguardandoAprovacaoPage() {
  ...
  return (
    <div className="bg-zinc-800 rounded-2xl p-8 shadow-2xl text-center">
      ...
      <h2 className="text-xl font-semibold text-white mb-3">Aguardando aprovação</h2>
      <p className="text-zinc-400 text-sm mb-6">
        Sua conta foi criada com sucesso. Um administrador irá aprovar seu acesso em breve.
      </p>
      <button
